        ...
        <Container maxWidth="md">
          ...
          {shouldShowResults && !shouldShowTimePicker &&
            <div css={style}>
              ...
              <h3>
                {format(add(timePickerValue, { hours: 1, minutes: 30 }), "hh:mm aa")}  - (1 Sleep Cycle, 1 hour and 30 minutes)
              </h3>
              <h3>
                {format(add(timePickerValue, { hours: 3 }), "hh:mm aa")}  - (2 Sleep Cycles, 3 hours)
              </h3>
              <h3>
                {format(add(timePickerValue, { hours: 4, minutes: 30 }), "hh:mm aa")}  - (3 Sleep Cycles, 4 hours and 30 minutes)
              </h3>
              <h3>
                {format(add(timePickerValue, { hours: 6 }), "hh:mm aa")}  - (4 Sleep Cycles, 6 hours)
              </h3>
              <h3>
                {format(add(timePickerValue, { hours: 7, minutes: 30 }), "hh:mm aa")}  - (5 Sleep Cycles, 7 hours and 30 minutes)
              </h3>
              <h3>
                {format(add(timePickerValue, { hours: 9 }), "hh:mm aa")}  - (6 Sleep Cycles, 9 hours)
              </h3>
              <p>
